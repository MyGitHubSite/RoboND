...
class RoverState():
    def __init__(self):
        ...
        self.obs_angles = None # Angles of navigable terrain pixels
        self.obs_dists = None # Distances of navigable terrain pixels
        ...
        self.mode = 'forward' # Current mode (can be forward, stop, collect, stuck)
        ...
        self.stuck_count = 0   # keeps track of time spent in a stuck mode
        self.stuck_time = 100    # time to perform action while in stuck mode
        self.seesrock = False      # does the rover see a rock?
